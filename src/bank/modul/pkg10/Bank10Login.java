 ...
 * @author Ilham Izzul
 */
public class Bank10Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        go.setFont(new java.awt.Font("Ebrima", 1, 12)); // NOI18N
        go.setText("CONFIRM");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bank10Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
